...
export const BANK_BY_GRADE = {
  "1": {
    ...
    "TV": {
      "T": [
        "Đọc to, chính xác các từ, câu, đoạn.",
        "Tiếp thu bài tốt, đọc thành thạo.",
        "Đọc lưu loát, rõ ràng và hiểu nghĩa bài đọc.",
        "Đọc trơn tốt các từ, câu.",
        "Viết chữ đúng mẫu và đẹp.",
        "Viết chữ đều và đẹp.",
        "Chữ viết sạch đẹp, đúng mẫu.",
        "Chữ đều nét, trình bày sạch đẹp.",
        "Vốn từ khá phong phú.",
        "Biết diễn đạt câu hay.",
        "Có khả năng ghi nhớ và kể chuyện tương đối tốt."
      ],
      "H": [
        "Đọc đúng, rõ ràng.",
        "Đọc đúng nội dung bài học.",
        "Chữ viết tương đối đều nét.",
        "Chữ viết rõ ràng, trình bày sạch sẽ.",
        "Biết diễn đạt những câu đơn giản.",
        "Bước đầu biết dùng từ, đặt câu."
      ],
      "C": [
        "Cần tích cực luyện đọc hơn.",
        "Cần tăng cường luyện đọc.",
        "Chưa có khả năng nghe – viết.",
        "Tốc độ viết bài còn chậm.",
        "Cần đọc sách, báo nhiều hơn để phát triển vốn từ.",
        "Diễn đạt câu chưa trọn vẹn."
      ]
    },
    "TNXH": {
      "T": [
      ...
      "H": [
        "Biết xử lí tình huống theo yêu cầu của bài học.",
        "Biết trả lời đúng nội dung câu hỏi theo từng chủ đề bài học.",
        "Nắm được nội dung bài học và vận dụng được vào cuộc sống.",
  ...
  "2": {
    ...
    "TV": {
      "T": [
        ...
        "Nắm được kiến thức về từ và câu, vận dụng để làm bài tập tốt.",
        "Nắm vững các kiểu câu và biết dùng từ đặt câu tốt.",
        "Có vốn từ phong phú.",
        "Tìm được nhanh các từ ngữ theo chủ đề đã học.",
      ...
      "H": [
        ...
        "Biết quan sát tranh và nêu từ ngữ tương ứng.",
        "Biết đặt câu nêu đặc điểm với từ cho trước.",
        "Đặt được câu giới thiệu với các từ chỉ sự vật cho trước.",
  ...
  "3": {
    ...
    "TV": {
      ...
      "H": [
        ...
        "Chữ viết sạch, đều nét.",
        "Chữ viết rõ ràng, trình bày sạch sẽ.",
        "Nắm vững vốn từ và đặt câu đúng.",
        "Biết sử dụng các biện pháp nghệ thuật trong viết văn.",
        "Viết được câu có đủ thành phần và diễn đạt được ý của mình.",
        "Viết bài tập làm văn đạt yêu cầu.",
        "Kể được câu chuyện theo gợi ý."
    ...
    "TNXH": {
      ...
      "H": [
        "Em nắm được nội dung bài học và vận dụng được vào cuộc sống.",
        "Nắm được kiến thức, kỹ năng cơ bản của môn học.",
        "Hoàn thành các yêu cầu nội dung chương trình.",
        "Hoàn thành nội dung kiến thức môn học."
      ],
