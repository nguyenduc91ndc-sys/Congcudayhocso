                            ...
                            {(activeTab === 'all' || activeTab === '3d') && (
                                <section className="mb-10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <ToolCard title="Phòng tranh 3D tùy chỉnh" description="Tạo phòng triển lãm 3D, gắn ảnh, video và chia sẻ link cho học sinh" icon={<Palette size={24} className="text-white" />} accentColor="bg-gradient-to-br from-pink-500 via-orange-400 to-yellow-400" onClick={onPhongTranh3D} badge="Mới" />
