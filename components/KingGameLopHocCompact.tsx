...
interface KingGameLopHocCompactProps {
    onBack: () => void;
}

const KingGameLopHocCompact: React.FC<KingGameLopHocCompactProps> = ({ onBack }) => {
        ...
        <div className="min-h-screen bg-gradient-to-br from-amber-900 via-yellow-800 to-orange-900">
            ...
            <div className="flex items-center gap-4 p-4 bg-black/30 backdrop-blur-sm border-b border-white/10">
                ...
                <h1 className="text-xl font-bold text-white flex items-center gap-2">
                    <span className="text-2xl">👑</span> Đường tới Ngôi Vua – Quản lý lớp học số
                </h1>
            </div>
...
export default KingGameLopHocCompact;
