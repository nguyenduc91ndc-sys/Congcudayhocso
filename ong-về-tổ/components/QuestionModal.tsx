          ...
          <div className="space-y-3 relative">
            ...
            {question.options.map((option) => {
              ...
              return (
                ...
                >
                  <span className={`inline-block w-10 h-10 text-center leading-10 rounded-full mr-4 font-bold transition-colors text-xl ${
                      selectedOption === option.id && showFeedback === 'correct' ? 'bg-green-500 text-white' : 
